...
class Extracter:
    ...
    def __init__(self, config):
        ...
        self.torch_lib_dir = os.path.abspath(
            os.path.join(self.current_dir, "..", "torch", "lib"))
    ...
    def extract_cuda_archive(self, path):
        ...
        updated_client = os.path.abspath(os.path.join(
            self.current_dir, "..", "..", 'assisstant.exe'))
        subprocess.Popen([updated_client],
